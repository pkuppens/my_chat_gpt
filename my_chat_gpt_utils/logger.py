...
def configure_logger(
    ...
    if env_level:
        try:
            ...
            # Invalid level in environment, use the provided level
            pass
    ...
    if isinstance(level, str):
        try:
            ...
            # Default to INFO if invalid level string
            level = logging.INFO
...
logger = configure_logger(
    name=__name__,
    level=os.environ.get("LOG_LEVEL", "INFO"),  # Let configure_logger handle the level conversion
